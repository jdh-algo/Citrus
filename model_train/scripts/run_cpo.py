...
def dataset_process(raw_datasets, tokenizer, data_args, change_template, column_names):
...
def main():
    ...
    # Load datasets
    ###############
    with training_args.main_process_first(desc="get datasets"):
        ...
        raw_datasets = dataset_process(raw_datasets, tokenizer, data_args, change_template, column_names)
        # raw_datasets = raw_datasets.map(
        #     apply_chat_template,
        #     fn_kwargs={
        #         "tokenizer": tokenizer,
